export default {
  ...
  'task-complete-notify-click-action': 'Acțiune la clic pe notificare',
  'task-complete-notify-click-action-tips': 'Alegeți ce se întâmplă când faceți clic pe notificarea de finalizare a descărcării',
  'task-complete-notify-click-action-open-folder': 'Deschideți folderul fișierului descărcat',
  'task-complete-notify-click-action-show-app': 'Afișați fereastra aplicației',
  ...
  'subnav-mode': 'Mod bară laterală secundară',
  'subnav-mode-floating': 'Folosește bara laterală secundară plutitoare',
  'subnav-mode-title': 'Folosește schimbarea din titlu',
  'language': 'Limba',
