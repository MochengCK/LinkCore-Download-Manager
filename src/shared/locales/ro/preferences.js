export default {
  ...
  'subnav-mode-floating': 'Folosește bara laterală secundară plutitoare (dezactivează schimbarea din titlu)',
  'subnav-mode-title': 'Folosește schimbarea din titlu (dezactivează bara laterală plutitoare)',
  'language': 'Limba',
