export default {
  ...
  'task-complete-notify-click-action': 'Bildirime tıklanınca yapılacak işlem',
  'task-complete-notify-click-action-tips': 'Tamamlanma bildirimine tıkladığınızda ne olacağını seçin',
  'task-complete-notify-click-action-open-folder': 'İndirilen dosyanın klasörünü aç',
  'task-complete-notify-click-action-show-app': 'Uygulama penceresini göster',
  ...
  'subnav-mode': 'Alt kenar çubuğu modu',
  'subnav-mode-floating': 'Yüzen alt kenar çubuğunu kullan',
  'subnav-mode-title': 'Başlıkla geçişi kullan',
  'language': 'Dil',
  ...
  'downloading-file-suffix-format-warning': 'İndirme soneki "." ile başlamalıdır, otomatik olarak eklenecektir',
  'extension-channel': 'Eklenti kanal URL\'si (Uygulama HTTP)',
  'extension-copy-channel': 'Kanal URL\'sini kopyala',
  ...
  'user-agent-du': 'du',
  'extension-rpc': 'Eklenti tarafından kullanılan RPC URL\'si',
  'extension-copy-rpc': 'RPC URL\'sini kopyala',
  'extension-tips': 'İndirmeleri otomatik olarak yakalamak için tarayıcı uzantısını yükleyin ve etkinleştirin',
  'extension-intercept-all-downloads': 'Tarayıcının tüm indirmelerini yakala',
  'extension-silent-download': 'Görev ekleme penceresini göstermeden doğrudan indirmeyi başlat',
  'extension-shift-toggle-enabled': 'Shift tuşuyla yakalamayı geçici olarak kapatmaya/açmaya izin ver',
  'extension-skip-file-extensions': 'Aşağıdaki dosya türlerini (uzantıları) yakalama',
  'extension-skip-file-extensions-tips': 'Örnek: exe,msi,zip; birden fazlasını virgül veya satır sonu ile ayırın',
  'extension-download': 'Eklentiyi indir',
  'extension-download-tips': 'Tarayıcı eklenti dosyasını masaüstüne kaydetmek için tıklayın',
  'extension-download-success': 'Eklenti dosyası kaydedildi',
  'extension-download-failed': 'Eklenti dosyası kaydedilemedi',
  'extension-file-not-found': 'Eklenti dosyası bulunamadı, lütfen dosya yolunu kontrol edin',
  'cancel': 'İptal',
  'save': 'Kaydet'
}
