export default {
  ...
  'subnav-mode-floating': 'Schwebende zusätzliche Seitenleiste verwenden (Titelumschaltung deaktivieren)',
  'subnav-mode-title': 'Titelumschaltung verwenden (schwebende Seitenleiste deaktivieren)',
  'language': 'Sprache',
