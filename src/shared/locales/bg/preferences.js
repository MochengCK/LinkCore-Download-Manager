export default {
  ...
  'task-complete-notify-click-action': 'Действие при клик върху уведомлението',
  'task-complete-notify-click-action-tips': 'Изберете какво да се случва при клик върху уведомлението за завършено изтегляне',
  'task-complete-notify-click-action-open-folder': 'Отваряне на папката с изтегления файл',
  'task-complete-notify-click-action-show-app': 'Показване на прозореца на приложението',
  ...
  'extension-channel': 'URL на канала на разширението (HTTP на приложението)',
  'extension-copy-channel': 'Копиране на URL на канала',
  'extension-rpc': 'RPC URL, използван от разширението',
  'extension-copy-rpc': 'Копиране на RPC URL',
  'extension-tips': 'Инсталирайте и активирайте разширението за браузъра, за да прихващате автоматично изтеглянията',
  'extension-intercept-all-downloads': 'Прихващане на всички изтегляния от браузъра',
  'extension-silent-download': 'Започване на изтеглянето директно без показване на прозорец за нова задача',
  'extension-shift-toggle-enabled': 'Разрешаване използването на клавиша Shift за временно изключване/включване на прихващането',
  'extension-skip-file-extensions': 'Да не се прихващат следните типове файлове (разширения)',
  'extension-skip-file-extensions-tips': 'Например: exe,msi,zip; няколко стойности разделяйте със запетая или нов ред',
  ...
  'extension-download': 'Изтегляне на разширението',
  'extension-download-tips': 'Щракнете, за да запишете файла на разширението на браузъра на работния плот',
  'extension-download-success': 'Файлът на разширението е запазен',
  'extension-download-failed': 'Грешка при запазване на файла на разширението',
  'extension-file-not-found': 'Файлът на разширението не съществува, проверете пътя до файла'
}
