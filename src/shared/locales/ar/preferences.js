export default {
  ...
  'task-complete-notify-click-action': 'إجراء عند النقر على إشعار اكتمال التحميل',
  'task-complete-notify-click-action-tips': 'اختر ما يحدث عند النقر على إشعار اكتمال التحميل',
  'task-complete-notify-click-action-open-folder': 'فتح المجلد الذي يحتوي على الملف المحمَّل',
  'task-complete-notify-click-action-show-app': 'إظهار نافذة التطبيق',
