export default {
  ...
  'subnav-mode-floating': 'Использовать плавающую боковую панель (отключить переключение заголовком)',
  'subnav-mode-title': 'Использовать переключение заголовком (отключить плавающую боковую панель)',
  'language': 'Язык',
