export default {
  ...
  'task-complete-notify-click-action': 'عمل هنگام کلیک روی اعلان تکمیل بارگیری',
  'task-complete-notify-click-action-tips': 'انتخاب کنید هنگام کلیک روی اعلان تکمیل بارگیری چه اتفاقی بیفتد',
  'task-complete-notify-click-action-open-folder': 'باز کردن پوشه حاوی فایل بارگیری‌شده',
  'task-complete-notify-click-action-show-app': 'نمایش پنجره برنامه',
