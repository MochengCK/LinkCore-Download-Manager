export default {
  ...
  'subnav-mode-floating': 'استفاده از نوار کناری فرعی شناور (غیرفعال کردن جابجایی از طریق عنوان)',
  'subnav-mode-title': 'استفاده از جابجایی از طریق عنوان (غیرفعال کردن نوار کناری شناور)',
  'language': 'زبان',
