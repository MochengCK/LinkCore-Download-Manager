export default {
  ...
  'task-complete-notify-click-action': 'Дія при натисканні на сповіщення',
  'task-complete-notify-click-action-tips': 'Виберіть, що відбувається при натисканні на сповіщення про завершення завантаження',
  'task-complete-notify-click-action-open-folder': 'Відкрити теку з завантаженим файлом',
  'task-complete-notify-click-action-show-app': 'Показати вікно застосунку',
