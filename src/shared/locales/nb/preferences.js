export default {
  ...
  'task-complete-notify-click-action': 'Handling ved klikk på varsling',
  'task-complete-notify-click-action-tips': 'Velg hva som skal skje når du klikker på fullføringsvarslingen',
  'task-complete-notify-click-action-open-folder': 'Åpne mappen med den nedlastede filen',
  'task-complete-notify-click-action-show-app': 'Vis applikasjonsvinduet',
  ...
  'subnav-mode-floating': 'Bruk flytende sidestolpe',
  'subnav-mode-title': 'Bruk bytte via tittel',
  'language': 'Språk',
