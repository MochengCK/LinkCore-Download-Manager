export default {
  ...
  'video-settings': '视频设置',
  'video-quality': '清晰度',
  'video-quality-placeholder': '自动',
  'video-format': '转换格式',
  'video-format-placeholder': '保持 MP4',
  'video-parsing': '正在解析视频信息…',
  'video-parse-failed': '解析失败',
  'video-info-title': '标题',
  'video-info-owner': '作者',
  'video-info-duration': '时长',
  'video-info-size': '大小',
  'videos': '个视频',
  'collection-videos': '合集视频',
  'select-all': '全选',
  'deselect-all': '取消全选',
  'uri-task-tips': '添加多个下载链接时，请确保每行只有一个链接（支持磁力链）',
  'video-task-tips': '添加 Bilibili 视频链接或 b23 短链接',
  ...
  'please-select-videos': '请至少选择一个视频',
  'no-video-urls': '未获取到视频链接',
  'task-gid': 'GID',
  'task-name': '任务名称',
  'task-out': '重命名',
  'task-out-tips': '选填',
